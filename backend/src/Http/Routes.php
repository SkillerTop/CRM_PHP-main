...
final class Routes
{
    public static function create(
        ...
        $r->add('GET', '/api/companies/{id}/contacts', fn (Request $request, array $p) => $contactController->forCompany($request, (int) $p['id']));
        $r->add('GET', '/api/companies/{id}/tasks', fn (Request $request, array $p) => $taskController->forCompany($request, (int) $p['id']));
        $r->add('GET', '/api/companies/{id}/log', fn (Request $request, array $p) => $companyController->log($request, (int) $p['id']));
        ...
        $r->add('GET', '/api/contacts/{id}/log', fn (Request $request, array $p) => $contactController->log($request, (int) $p['id']));
        ...
        $r->add('GET', '/api/tasks/{id}', fn (Request $request, array $p) => $taskController->show($request, (int) $p['id']));
        ...
        $r->add('GET', '/api/tasks/{id}/comments', fn (Request $request, array $p) => $taskController->comments($request, (int) $p['id']));
        ...
        $r->add('GET', '/api/tasks/{id}/log', fn (Request $request, array $p) => $taskController->log($request, (int) $p['id']));
        ...
        $r->add('GET', '/api/lookups/{type}/{id}/log', fn (Request $request, array $p) => $lookupController->log($request, (string) $p['type'], (int) $p['id']));

        $r->add('GET', '/api/users', fn (Request $request) => $userController->index($request));
        ...
        $r->add('GET', '/api/users/{id}/log', fn (Request $request, array $p) => $userController->log($request, (int) $p['id']));
