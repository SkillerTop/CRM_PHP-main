...
Feature modules may depend on `components`, `hooks`, `lib` and `api-client`,
but should not import another feature directly. Cross-feature orchestration
belongs in the application shell.
