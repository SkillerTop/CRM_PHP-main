...
final class ReminderService
{
    ...
    private function deliver(int $reminderId): string
    {
        ...
        try {
            ...
            $this->mark($reminderId, 'failed', $recipient, $error->getMessage());
            $this->audit->log('REMINDER FAILED', 'Task', (int) $row['task_id'], (string) $row['name'], detail: ['recipient' => $recipient, 'error' => $error->getMessage()], actorName: 'system');
            return 'failed';
        }
    }
