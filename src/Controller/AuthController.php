...
final class AuthController
{
    ...
    public function login(Request $request): never
    {
        ...
        $this->limiter->clear('login', $rateKey);
        $now = Clock::dbNow();
    ...
    {
        $this->limiter->ensureAllowed('register', $request->ip());
        $data = $request->json();
    ...
    {
        $this->limiter->ensureAllowed('forgot_password', $request->ip());
